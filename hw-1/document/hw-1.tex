...
The difference is $\Delta \dot{W} = \dot{W}_s - \dot{W}_{actual} = 1797.8 - 1528.0 = 269.8$ kW. This verifies the calculation since $w_{actual} = \eta_s \times w_s = 0.85 \times 719.1 = 611.2$ kJ/kg.
